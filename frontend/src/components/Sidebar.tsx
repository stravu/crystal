            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 border-gray-300 dark:border-gray-600">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 border-gray-300 dark:border-gray-600">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 border-gray-300 dark:border-gray-600">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 border-gray-300 dark:border-gray-600">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 border-gray-300 dark:border-gray-600">
                    ...
                    <div className="flex items-center gap-3 p-2 rounded">
                      <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded border bg-gray-100 dark:bg-gray-900/30 text-gray-600 dark:text-gray-400 border-gray-300 dark:border-gray-600">
