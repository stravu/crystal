...
export const ClaudeSettingsPanel: React.FC<ClaudeSettingsPanelProps> = ({
  settings,
  onSettingsChange,
  onClose,
}) => {
  ...
  return (
    <>
      ...
      {/* Settings Dropdown - positioned relative to the panel */}
      <div className="absolute top-10 right-4 w-80 z-30 bg-surface-primary border border-border-primary rounded-lg shadow-lg animate-in fade-in slide-in-from-top-1 duration-200">
        <div className="p-4">
